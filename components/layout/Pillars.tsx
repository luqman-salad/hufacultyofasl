...
import { BookOpen, Scale, Users, Award } from 'lucide-react';
...
const pillars = [
  {
    ...
    description: "Deepening understanding of Shari'a principles and contemporary legal applications.",
    icon: BookOpen,
  ...
  },
  {
    ...
    description: "Cultivating principled leadership rooted in justice, responsibility, and Islamic ethics.",
    icon: Scale,
  ...
  },
  {
    ...
    description: "Preparing visionary leaders equipped to guide and serve society with integrity.",
    icon: Users,
  ...
  },
  {
    ...
    description: "Delivering rigorous scholarly curricula to shape tomorrow's administrative and legal pioneers.",
    icon: Award,
