      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold uppercase tracking-widest">Faculty of Shari'a & Leadership</h2>
            <p className="text-gray-300 text-sm leading-relaxed max-w-xs">
              Empowering future leaders with deep Islamic jurisprudence and principled ethical governance.
            </p>
          ...
          <div className="space-y-4 text-sm text-gray-300">
            ...
            <p className="flex items-center gap-3"><Mail className="text-[#E31E24]" size={16} /> info@sharia.edu.so</p>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 text-center text-[11px] text-gray-400 uppercase tracking-widest">
          <p>© {new Date().getFullYear()} Faculty of Shari'a & Leadership. Designed & Developed by <Link href="https://luqmansalad.com" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors underline">Luqman</Link></p>
        </div>
      </div>
    </footer>
  );
