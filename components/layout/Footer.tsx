    ...
    <footer className="bg-[#1F2E4F] text-white pt-16 pb-8">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="pt-8 border-t border-white/10 text-center text-[11px] text-gray-400 uppercase tracking-widest">
          <p>© 2026 Faculty of Shari'a & Leadership. Designed & Developed by <Link href="https://luqmansalad.com" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors underline">Luqman</Link></p>
        </div>
      </div>
    </footer>
  );
